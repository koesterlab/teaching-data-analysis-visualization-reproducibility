...
Thereby, the sections about installing Datavzrd can be skipped since we can use our datavzrd environment from the previous part of the course.
Just activate it as you have learned and follow the tutorial in a new subfolder ``chapters/datavzrd``, starting with `"Download example data" <https://datavzrd.github.io/docs/tutorial.html#download-example-data>`__.
